...
public class AIPlayer extends AbstractPlayer {
	...
	/** Liste des possibilités de couleurs pour la génération des combinaisons */	
	private List<List> colorCombination = new ArrayList<List>();
	...
	public AIPlayer() {
		...
		if(combinationType.equals("numbers")) {
			...
			for(int i = 0; i < this.combinationLenght; i++)
				colorCombination.add(combinationPossibleColors);
		}
	}
